...
export default class ProductManager {
    ...
    async addProduct({title, description, code, price, status = true, stock, category, thumbnail}) {
        const validationError = this.validateInputs(title, description, code, price, stock, category);
        
        console.log(`VALIDATION ---> ${validationError}`)
        if (validationError) {
            console.log(`VALIDATION detro del IF---> ${validationError}`)
    ...
    validateInputs(title, description, code, price, stock, category) {
